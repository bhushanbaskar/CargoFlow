...
import { Truck, Bus, ArrowRight, XCircle, CheckCircle2, AlertTriangle, Sparkles } from 'lucide-react';
    ...
    <section id="product" className="py-20 lg:py-28 bg-[#f4f5f7] border-b border-zinc-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-zinc-200/90 shadow-2xs space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-4 gap-2 text-center text-xs font-bold text-zinc-700">
                <div className="bg-zinc-50 p-3 rounded-2xl border border-zinc-200/80 space-y-1">
                  <div className="text-[10px] text-zinc-400 uppercase">Step 01</div>
                  <div>Courier</div>
                </div>
                <div className="bg-red-50/60 p-3 rounded-2xl border border-red-200/80 space-y-1">
          ...
          <div className="bg-zinc-950 text-white rounded-3xl p-6 sm:p-8 border border-zinc-800 shadow-xl space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-4 gap-2 text-center text-xs font-bold text-zinc-200">
                ...
                <div className="bg-zinc-900 p-3 rounded-2xl border border-lime-400/40 space-y-1 text-lime-300">
